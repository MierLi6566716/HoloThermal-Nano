...
results_dir_list["blue"] = (
    "/jixie/yujie_codes/holonet_compression/retrain_HardTanh/ours_step1_blue_hardTanh_scratch_scale0.95_correct_kpl/train_log/results/test-ckpt-48-compress-rescale-0520-b-2"
)
results_dir_list["green"] = (
    "/jixie/yujie_codes/holonet_compression/retrain_HardTanh/ours_step1_green_hardTanh_scale0.95_correct_again/train_log/results/test-ckpt-59-compress-rescale-0520-g-2"
)
results_dir_list["red"] = (
    "/jixie/yujie_codes/holonet_compression/retrain_HardTanh/red_step1_temp_rescale/ours_step1_red_hardTanh_scale0.95_scratch_correct_again_again/train_log/results/test-ckpt-41-compress-rescale-0520-r-2"
)
