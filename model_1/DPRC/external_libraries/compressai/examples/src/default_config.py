...
class args(object):
    ...
    # Scheduling
    lambda_schedule = dict(vals=[2.0, 1.0], steps=[50000])
    lr_schedule = dict(vals=[1.0, 0.1], steps=[500000])
    target_schedule = dict(vals=[0.20 / 0.14, 1.0], steps=[50000])  # Rate allowance
